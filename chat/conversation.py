...
We kindly request that you import chat instead of copying this file if you want to use it.
...
3. Outdoor Movie Night: Set up a backyard movie night with a projector and a large screen or white sheet. Create a cozy seating area with blankets and pillows, and server popcorn and snacks while the kids enjoy a favorite movie under the stars.
...
# llama2-testGPT template
register_conv_template(
    Conversation(
        name="llama-2-testgpt",
        system_template="<s>human\n {system_message}<s>bot\n",
        roles=("<s>human\n", "<s>bot\n"),
        sep_style=SeparatorStyle.LLAMA2_TESTGPT,
        sep=" ",
        sep2=" </s><s>",
    )
)
