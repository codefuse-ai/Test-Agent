...
Usage:
python3 -m chat.server.cli --model lmsys/vicuna-7b-v1.3
python3 -m chat.server.cli --model lmsys/chat-t5-3b-v1.0
...
from chat.model.model_adapter import add_model_args
from chat.modules.gptq import GptqConfig
from chat.modules.awq import AWQConfig
from chat.server.inference import ChatIO, chat_loop
