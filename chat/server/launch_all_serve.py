...
The key mechanism behind this scripts is: 
    ...
    2, check the log of controller/worker/openai-api-server to ensure that the server is launched properly.
Note that a few of non-critical `chat.server` cmd options are not supported currently.
"""
import sys
import os
...
# 2,LOGDIR
# 3, log file name
base_launch_sh = "nohup python3 -m chat.server.{0} {1} >{2}/{3}.log 2>&1 &"
